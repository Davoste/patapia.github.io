...
<nav class="navbar nav-sticky navbar-light bg-light">
  ...
  <a class="nav-item " href="#">
    <span class="nav-link" >LastT</span>
  </a>
  <a href="acc.php" class="nav-item text-dark">
    <svg class="d-inline-block align-top" width="24" height="24"><use xlink:href="#people-circle"/></svg>
      $<span ><?php echo htmlspecialchars($row["balance"]); ?></span>
  </a>
</nav>
<body>
              ...
              if ($result->num_rows > 0) {
                  while ($row = $result->fetch_assoc()) {
                      ...
                      if ($timeRemaining > 0) {
                          ...
                          echo '<p>Next Draw In: <span class="countdown" id="countdown" data-remaining="' . $timeRemaining . '">' . $hoursRemaining . 'h ' . $minutesRemaining . 'm ' . $secondsRemaining . 's</span></p>';
                          echo '</div>';
                      } else {
                          
                          header("Location: draw2.php");
                          echo '<div>';
...
.border span {
  ...
  <div class="card">
  <div class="title">
    <p class="heading">PREVIOUS WINNERS</p>

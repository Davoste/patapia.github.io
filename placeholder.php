...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
  ...
  <div class="px-3 py-2 text-bg-dark">
      <div class="container" id="header">
        <div class="col-md-12 col-sm-12 d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
         

          <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
            <li>
              <a href="/" class="nav-link text-white">
                <img class="me-3" src="./supersteez.png" alt="" width="100" height="50">
                BucksHour
              </a>
            </li>
            ...
            <li>
              <a href="#" class="nav-link text-white">
                ...
                <p>$<span id="userBalance"><?php echo htmlspecialchars($row["balance"]); ?></span></p>
              </a>
            </li>
          </ul>
        </div>
  ...
  <section>
  <?php 
            $drawID= generateUniqueDrawID($db);
            function generateUniqueDrawID($db){
              
              $drawID = mt_rand(1000, 9999);//random 4 digit nu
              
              //check if id already exists
              $sql= 'SELECT drawid FROM posswin WHERE drawid=$drawID ';
              $result = $db->query($sql);

              // If the draw ID already exists, generate a new one recursively
              if ($result && $result->num_rows > 0) {
                  return generateUniqueDrawID($db);
              }
                  // Insert the new draw ID into the database
              $sql = "INSERT INTO posswin (drawid) VALUES ('$drawID')";
    ...
    <div class="row">
        ...
        <div class="col-xl-6 col-lg-6 col-md-12 padding_right1">
          ...
          <?php 
            $sql = "SELECT cumstake FROM posswin WHERE drawid='$drawID'";
            $result = mysqli_query($db, $sql);
            $line = mysqli_fetch_assoc($result)

          ?>
            <label id="text"> Possible Win:</label><label id="win"><?php echo htmlspecialchars($line["cumstake"]); ?> </label><br>
            <label id="text"> Draw ID: <?php echo $drawID; ?></label>
   ...
   // Function to fetch user account balance from the database
        ...
        function startTimer(duration, displayElementId) {
                    ...
                    setInterval(function () {
                        ...
                        document.getElementById(displayElementId).textContent = minutes + ":" + seconds;
                ...
                // Start the countdown timer for 3 minutes (180 seconds)
                startTimer(300, "timer"); // "timer" is the ID of the element where the timer will be displayed
